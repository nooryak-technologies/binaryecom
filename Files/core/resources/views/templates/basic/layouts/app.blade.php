...
<head>
    ...
    <link href="{{ asset($activeTemplateTrue . 'css/organic-landing.css') }}?v={{ time() }}" rel="stylesheet">
...
<body class="organic-body">
    ...
    @if ($cookie && @$cookie->data_values->status == Status::ENABLE && !\Cookie::get('gdpr_cookie'))
        <div class="cookies-card hide text-center">
            ...
            <p class="cookies-card__content mt-4">{{ @$cookie->data_values->short_desc ?? 'We use cookies to improve your experience.' }} <a href="{{ route('cookie.policy') }}"
